document.addEventListener('DOMContentLoaded', () => {
  ...
  const Ablock = 
  [1,2,3,4,5,6,7,8,9,73,81,145,149,153,217,220,222,225,289,291,295,297,361,363,364,365,366,367,369,433,435,439,441,505,513,577,578,579,580,581,582,583,584,585]  
 ...
 const Bblock =
  ...
  const Nblock =
  [28, 29, 30, 31, 32, 33, 34, 35, 36, 100, 108, 172, 174, 178, 180, 244, 246, 
   247, 250, 252, 316, 318,320, 322, 324, 388, 390, 393, 394, 396, 460, 462,
   466, 468, 532, 540, 604, 605, 606, 607, 608, 609, 610, 611, 612]

  const Oblock =
  [37, 38, 39, 40, 41, 42, 43, 44, 45,109, 181, 253, 325, 397, 469, 541, 613, 
   614, 615, 616, 617, 618, 619, 620, 621, 117, 189, 261, 333, 405, 477, 549,
   184,	185, 186, 255, 327, 399, 472, 473, 474, 259, 331, 403]

  const Pblock =
  [46, 47, 48, 49, 50, 51, 52, 53, 54, 622, 623, 624, 625, 626, 627, 628, 629,
   630, 118, 190, 262, 334, 406, 478, 550, 126, 198, 270, 342, 414, 486, 558,
   192, 193, 194, 195, 196, 264, 336, 408, 480, 337, 338, 339, 340, 268]

  const Qblock =
  [19, 20, 21, 22, 23, 24, 25, 26, 27, 165, 166, 167, 168, 453, 454, 455, 456, 
   457, 595, 596, 597, 598, 599, 600, 601, 602, 603, 91, 163, 235, 307, 379, 
   451, 523, 99, 171, 243, 315, 387, 459, 531, 237, 309, 381, 240, 312, 384]

  const Rblock =
  [46, 47, 48, 49, 50, 51, 52, 53, 54, 622, 623, 624, 625, 626, 627, 628, 629, 
   630, 192, 193, 194, 195, 336, 337, 338, 339, 264, 408, 480, 411, 484, 268,
   118, 190, 262, 334, 406, 478, 550, 126, 198, 270, 342, 414, 486, 558]

  const Sblock =
  [37, 38, 39, 40, 41, 42, 43, 44, 45, 613, 614, 615, 616, 617, 618, 619, 620,
   621, 183, 184, 185, 186, 187, 327, 328, 329, 330, 331, 471, 472, 473, 474,
   475, 255, 403, 117, 189, 261, 333, 405, 477, 549, 109, 181, 253, 325, 397,
   469, 541]

  const Tblock =
  [37, 38, 39, 40, 41, 42, 43, 44, 45, 613, 614, 615, 616, 617, 618, 619, 620, 
   621, 183, 184, 185, 186, 187, 109, 181, 253, 325, 397, 469, 541, 117, 189,
   261, 333, 405, 477, 549, 257, 329, 401, 473]

  const Ublock =
  [1, 2, 3, 4, 5, 6, 7, 8, 9, 435, 436, 437, 438, 439, 577, 578, 579, 580, 581,
   582, 583, 584, 585, 73, 145, 217, 289, 361, 433, 505, 81, 153, 225, 297, 369,
   441, 513, 147, 219, 291, 363, 151, 223, 295, 367]

  const Vblock =
  [64, 65, 66, 67, 68, 69, 70, 71, 72, 640, 641, 642, 643, 644, 645, 646, 647, 
   648, 136, 208, 280, 352, 424, 496, 568, 144, 216, 288, 360, 432, 504, 576,
   210, 282, 354, 214, 286, 358, 427, 429, 500]

  const Wblock =
  [10, 11, 12, 13, 14, 15, 16, 17, 18, 586, 587, 588, 589, 590, 591, 592, 593,
   594, 82, 154, 226, 298, 370, 442, 514, 156, 228, 300, 372, 444, 160, 232, 
   304, 376, 448, 90, 162, 234, 306, 378, 450, 522, 302, 373, 375]

  const Xblock =
  [19, 20, 21, 22, 23, 24, 25, 26, 27, 595, 596, 597, 598, 599, 600, 601, 602,
   603, 91, 163, 235, 307, 379, 451, 523, 99, 171, 243, 315, 387, 459, 531, 165,
   169, 238, 240, 311, 382, 384, 453, 457]
  ...
  //const Letters = Blocks.filter()
  
  //function deleteArrIndex {
